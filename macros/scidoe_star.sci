...
function H = scidoe_star(varargin)
    ...
    //    Parameter : a 1-by-n matrix of strings, the desirable type of design, which defines the value of alpha. Computation of alpha is described in "Description". Default is "orthogonal".
    ...
    apifun_checklhs("scidoe_star",lhs,1)
