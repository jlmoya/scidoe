...
[B_computed,bint_computed,r_computed,rint_computed,stats] = scidoe_multilinreg(Y,X);

assert_checkalmostequal(B_expected,B_computed,[],[],"element");
assert_checkalmostequal(bint_expected,bint_computed,[],[],"element");
assert_checkalmostequal(r_expected,r_computed,[],[],"e;ement");
assert_checkalmostequal(rint_expected,rint_computed,[],[],"element");
assert_checkalmostequal(stats.ResidualMean,6.848);
assert_checkalmostequal(stats.R2,0.3528);
assert_checkalmostequal(stats.pval,33.70);
assert_checkalmostequal(stats.F,1.3626);
